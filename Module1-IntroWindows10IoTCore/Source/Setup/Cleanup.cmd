...
DEL "%MyDocuments%\Visual Studio 2015\Code Snippets\Visual C#\My Code Snippets\Win10IoT*.snippet" 2>NUL
DEL "%MyDocuments%\Visual Studio 2015\Code Snippets\XML\My Xml Snippets\Win10IoT*.snippet" 2>NUL
